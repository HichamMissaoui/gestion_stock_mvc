		...
		<ul class="nav" id="side-menu">
			<li class="sidebar-search">
				<div class="input-group custom-search-form">
					<input type="text" class="form-control" placeholder="<fmt:message key="common.recherche"/>">
			...
			<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
				...
				<c:url value="/client/" var="client" />
					...
					<li><a href="${cmdClient }"><fmt:message key="common.client.commande"/></a></li>
				...
				<c:url value="/fournisseur/" var="fournisseur" />
					...
					<li><a href="${cmdFournisseur }"><fmt:message key="common.fournisseur.commande"/></a></li>
				</ul> <!-- /.nav-second-level --></li>
